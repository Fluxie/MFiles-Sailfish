...
SilicaListView {
    ...
    property alias listing: rootModel.listing
    ...
    ViewPlaceholder {
        ...
        text: ( ! listView.listing || listView.listing.status === ListingStatus.Refreshing || !listView.listing.empty ) ? 'Refreshing...' : 'No results'
    }
